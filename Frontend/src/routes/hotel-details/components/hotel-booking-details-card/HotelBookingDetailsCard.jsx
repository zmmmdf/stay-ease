...
const HotelBookingDetailsCard = ({ hotelCode }) => {
  ...
  const roomOptions = [
    ...
    {
      value: '1 Standard Bed Standard Non Smoking',
      label: '1 Standard Bed Standard Non Smoking',
    },
  ];
  ...
  const calculatePrices = () => {
    ...
    if (!isNaN(totalPrice)) {
      setTotal(`${formatPrice(totalPrice)} AZN`);
    }
    setTaxes(`${formatPrice(totalGst)} AZN`);
  };
    ...
    <div className="mx-2 bg-white shadow-xl rounded-xl overflow-hidden mt-2 md:mt-0 w-full md:w-[380px]">
      ...
      <div className="p-6 text-sm md:text-base">
        ...
        <div className="mb-4">
          ...
          <div className="text-gray-600">
            {formatPrice(bookingDetails.currentNightRate)} AZN
          </div>
        </div>
